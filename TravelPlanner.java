...
public class TravelPlanner{
	...
	public static void main(String[] args) {
		...
		planner.addDestination("Paris",new Date(2024,4,10));
		planner.addBudget("Paris",2000.0);
		planner.addDestination("Rome",new Date(2024,5,1));
		planner.addBudget("Rome",2500.0);
